<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:73:"H:\gitfiles\dese001\shop2\public/../application/admin\view\attr\edit.html";i:1526113734;s:66:"H:\gitfiles\dese001\shop2\application\admin\view\common\_meta.html";i:1525222954;s:64:"H:\gitfiles\dese001\shop2\application\admin\view\common\top.html";i:1524733303;s:65:"H:\gitfiles\dese001\shop2\application\admin\view\common\left.html";i:1525850320;s:67:"H:\gitfiles\dese001\shop2\application\admin\view\common\footer.html";i:1525222954;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	    <meta charset="utf-8">
                            ...
                            <div class="col-sm-6">
                                <select name="type_id">
                                    <?php if(is_array($attrlist) || $attrlist instanceof \think\Collection || $attrlist instanceof \think\Paginator): $i = 0; $__LIST__ = $attrlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$type): $mod = ($i % 2 );++$i;
                                     foreach ($type as $k => $v): 
                                        if(!is_int($v)): ?>
                                        <option <?php if($type['type_id'] == $attr['type_id']): ?> selected="selected" <?php endif; ?> value="<?php echo $type['type_id']; ?>"><?php echo $v;?></option>
