<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:72:"H:\gitfiles\dese001\shop2\public/../application/admin\view\attr\add.html";i:1525941800;s:66:"H:\gitfiles\dese001\shop2\application\admin\view\common\_meta.html";i:1525222954;s:64:"H:\gitfiles\dese001\shop2\application\admin\view\common\top.html";i:1524733303;s:65:"H:\gitfiles\dese001\shop2\application\admin\view\common\left.html";i:1525850320;s:67:"H:\gitfiles\dese001\shop2\application\admin\view\common\footer.html";i:1525222954;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	    <meta charset="utf-8">
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-sm-6">
                                <select name="type_id">
                                    ...
                                    <?php if(is_array($attrlist) || $attrlist instanceof \think\Collection || $attrlist instanceof \think\Paginator): $i = 0; $__LIST__ = $attrlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$type): $mod = ($i % 2 );++$i;
                                     foreach ($type as $k => $v): 
                                        if(!is_int($v)): ?>
                                        <option value="<?php echo $type['type_id'] ?>"><?php echo $v?></option>
                                    <?php endif;endforeach; endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="radio" style="float:left; padding-right: 10px;">
                                    <label>
                                        <input class="inverted colored-blue" value="1" name="attr_type" type="radio" checked="checked">
                                        <span class="text">单选</span>
                                    </label>
                                </div>
                                <div class="radio" style="float:left; padding-right: 10px;">
                                    <label>
                                        <input class="inverted colored-blue" value="2" name="attr_type" type="radio">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <textarea class="form-control" id="username" placeholder="" name="attr_values" type="text"></textarea>
                            </div>
