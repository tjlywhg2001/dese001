<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:73:"H:\gitfiles\dese001\shop2\public/../application/admin\view\type\list.html";i:1526114880;s:66:"H:\gitfiles\dese001\shop2\application\admin\view\common\_meta.html";i:1525222954;s:64:"H:\gitfiles\dese001\shop2\application\admin\view\common\top.html";i:1524733303;s:65:"H:\gitfiles\dese001\shop2\application\admin\view\common\left.html";i:1525850320;s:67:"H:\gitfiles\dese001\shop2\application\admin\view\common\footer.html";i:1525222954;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	    <meta charset="utf-8">
...
<button type="button" tooltip="添加用户" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('type/add'); ?>'"> <i class="fa fa-plus"></i> 添加商品类型
</button>
<div class="row">
                ...
                <div class="flip-scroll">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                                ...
                                <td align="center">
                                    <a href="<?php echo url('attr/lst'); ?>" class="btn btn-sm btn-warning shiny">
