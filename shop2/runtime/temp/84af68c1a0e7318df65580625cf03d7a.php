<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:74:"H:\gitfiles\dese001\shop2\public/../application/admin\view\brand\edit.html";i:1524467704;s:66:"H:\gitfiles\dese001\shop2\application\admin\view\common\_meta.html";i:1524449075;s:64:"H:\gitfiles\dese001\shop2\application\admin\view\common\top.html";i:1524449075;s:65:"H:\gitfiles\dese001\shop2\application\admin\view\common\left.html";i:1524449075;s:67:"H:\gitfiles\dese001\shop2\application\admin\view\common\footer.html";i:1524449075;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	    <meta charset="utf-8">
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="username" placeholder="" name="brand_name" rtype="text" value="<?php echo $brands['brand_name']; ?>">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="username" placeholder="" name="brand_url" type="text" value="<?php echo $brands['brand_url']; ?>">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="username" placeholder="" name="brand_description" type="text" value="<?php echo $brands['brand_description']; ?>">
                            </div>
                            <p class="help-block col-sm-4 red"></p>
                        </div>
