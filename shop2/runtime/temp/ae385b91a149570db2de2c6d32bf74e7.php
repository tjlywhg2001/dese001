<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:77:"H:\gitfiles\dese001\shop2\public/../application/admin\view\category\list.html";i:1524563996;s:66:"H:\gitfiles\dese001\shop2\application\admin\view\common\_meta.html";i:1524449075;s:64:"H:\gitfiles\dese001\shop2\application\admin\view\common\top.html";i:1524449075;s:65:"H:\gitfiles\dese001\shop2\application\admin\view\common\left.html";i:1524449075;s:67:"H:\gitfiles\dese001\shop2\application\admin\view\common\footer.html";i:1524449075;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	    <meta charset="utf-8">
...
<button type="button" tooltip="添加用户" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('Category/add'); ?>'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
                ...
                <div class="flip-scroll">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                                ...
                                <td align="+center" width="12%"><?php echo '|'.str_repeat('-',$category['lever']*4).'&nbsp' ?><?php echo $category['cate_name']; ?></td>
<!--                                 <td align="+center" width="12%"><?php echo str_repeat('&nbsp',$category['lever']*2).'┗'.str_repeat('━',$category['lever']).'&nbsp' ?><?php echo $category['cate_name']; ?></td>
 -->                                <td align="center" width="5%"><?php echo $category['cate_type']; ?></td>
                                ...
                                <td align="center" width="4%">
                                    <input type="text" value="<?php echo $category['cate_sort']; ?>" style="width: 30px; text-align: center;" />
                                </td>
